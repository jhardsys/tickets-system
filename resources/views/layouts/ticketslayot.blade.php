...
<body>
    <header class="header">
        <nav class="nav">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-list navOpenBtn" viewBox="0 0 16 16">
            ...
            <ul class="nav-links">
                ...
                <li><a href="{{ url('app/client/tickets/create') }}" class="nav__link-enviar-ticket">Enviar un
                        ticket</a></li>
            ...
            <div class="perfil" id="perfilContainer">
                <a class="perfil__a" href="{{ route('client.perfil.index') }}">
                    <p>P</p>
                </a>
            </div>
        </nav>
    ...
    <main class="main">
        <div class="head" style="flex-direction: column;">
